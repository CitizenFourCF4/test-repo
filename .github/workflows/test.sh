...
HEADER="*UPDATE ⚙️*"
WHAT_WAS_ADDED="_*WHAT WAS ADDED?*_"

if [ -z "$DETAILS" ]; then
   DETAILS="Developer left no comments"
fi

MESSAGE="$HEADER%0A%0A$PR_TITLE%0A%0A$WHAT_WAS_ADDED%0A$DETAILS%0A%0A_repository name_| $REPOSITORY_NAME%0A_developer_| $DEVELOPER_LOGIN"
